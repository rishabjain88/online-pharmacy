...
function Item({Barcode1,ProductName1,Quantity,ReorderQuantity,Price}){
 ...
 setflag(false);
fetch("http://a8f26593ac43.ngrok.io/product",{
...
fetch("http://a8f26593ac43.ngrok.io/productReorder",{
...
const search2=(Barcode1)=>{
  fetch("http://a8f26593ac43.ngrok.io/searchProduct",{
...
// allert();
  fetch("http://a8f26593ac43.ngrok.io/delete2",{
...
const UpdateProduct=()=>{
  ...
  fetch("http://a8f26593ac43.ngrok.io/UpdateProduct",{
...
const search=()=>{
  ...
  setflag(false);
  setflag2(false);
  fetch("http://a8f26593ac43.ngrok.io/search2",{
